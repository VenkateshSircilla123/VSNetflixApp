  ...
  return (
    <div className='login-screen'>
      ...
      <div className='enjoy-section'>
        ...
        <div className='tv'>
          ...
          <video autoPlay loop className='tv-video'>
              <source  src="https://assets.nflxext.com/ffe/siteui/acquisition/ourStory/fuji/desktop/video-tv-in-0819.m4v" autoPlay type="video/mp4" className='p'/>
          </video>
        </div>
      </div>
      <div className='download-section'>
          <div className='mobile'>
            <img src='./images/mobile.jpg' className='dsimg'></img>
      ...
      <div className='kids-section'>
        <img src='./images/kids.png' className='ksi'/>
        <div className='text'>
          <h1>Create profiles for kids</h1>
          <h4 className='kdsdes'>Send children on adventures with their favourite characters in a space made just for them—free with your membership.</h4>
        </div>
      </div>
